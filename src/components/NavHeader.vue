					...
					<div class="confirm-tips">
						...
						<ul>
							<li class="regi_form_input">
								...
								class="regi_login_input regi_login_input_left" placeholder="请输入您的账号" data-type="loginname">
							</li>
							<li class="regi_form_input noMargin">
								<i class="icon IconPwd"></i>
								<input type="password" tabindex="2" name="password" v-model="userPwd"
								class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请输入您的密码"
								@keyup.enter="login">
							</li>
						</ul>
					</div>
